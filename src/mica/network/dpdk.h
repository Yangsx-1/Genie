...
struct BasicDPDKConfig {
  ...
  static constexpr bool filterVerbose = false;
};
...
class DPDK : public PacketIOInterface {
 public:
  ...
  // void sym_hash_enable(int port_id, uint32_t ftype, enum rte_eth_hash_function function);
  // void sym_hash_set(int port_id, int enable);//xhj
