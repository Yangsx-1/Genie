...
#else
    method =
        ((SafeIntCompare<T, U>::isLikeSigned)
             ? ComparisonMethod_Ok
             ...
             : (IntRegion<T, U>::IntZone_Uint32_UintLT64 ||
                IntRegion<T, U>::IntZone_UintLT32_Uint32)
                   ...
                   : SafeIntCompare<T, U>::isBothUnsigned &&
                             IntTraits<T>::isUint64 && IntTraits<U>::isUint64
                         ...
                         : (IntRegion<T, U>::IntZone_Uint64_Uint)
                               ...
                               : (IntRegion<T, U>::IntZone_UintLT64_Uint64)
                                     ...
                                     (IntRegion<T, U>::IntZone_UintLT32_IntLT32)
                                         ...
                                         : (IntRegion<
                                                T, U>::IntZone_Uint32_IntLT64 ||
                                            IntRegion<
                                                T, U>::IntZone_UintLT32_Int32)
                                               ? MultiplicationState_CastInt64
                                               : (IntRegion<
                                                     T, U>::IntZone_Uint64_Int)
                                                     ? MultiplicationState_Uint64Int
                                                     : (IntRegion<T, U>::
                                                            IntZone_UintLT64_Int64)
...
class MultiplicationHelper<T, U, MultiplicationState_Uint64Uint64> {
 public:
  ...
  static void MultiplyThrow(const unsigned __int64& t,
    ...
    unsigned __int64 u1 = u;
    LargeIntRegMultiply<unsigned __int64, unsigned __int64>::
        template RegMultiplyThrow<E>(t1, u1,
...
class MultiplicationHelper<T, U, MultiplicationState_Uint64Uint> {
 public:
  ...
  static void MultiplyThrow(const T& t, const U& u, T& ret) SAFEINT_CPP_THROW {
    ...
    unsigned __int64 t1 = t;
    LargeIntRegMultiply<unsigned __int64, unsigned __int32>::
        template RegMultiplyThrow<E>(t1, (unsigned __int32)u,
                                     reinterpret_cast<unsigned __int64*>(&ret));
  }
};
 ...
 public:
  ...
  static void MultiplyThrow(const T& t, const U& u, T& ret) SAFEINT_CPP_THROW {
    ...
    LargeIntRegMultiply<unsigned __int64, signed __int32>::
        template RegMultiplyThrow<E>(t1, (signed __int32)u,
                                     reinterpret_cast<unsigned __int64*>(&ret));
  }
};
                          ...
                          IntRegion<T, U>::IntZone_Uint64_Int64)
                             ...
                             : (IntRegion<T, U>::IntZone_UintLT64_Int64)
                                   ...
                                   (IntRegion<T, U>::IntZone_IntLT32_IntLT32)
                                       ? SubtractionState_CastIntCheckSafeIntMinMax
                                       : (IntRegion<T,
                                                    U>::IntZone_Int32_IntLT64 ||
                                          IntRegion<T,
                                                    U>::IntZone_IntLT32_Int32)
                                             ? SubtractionState_CastInt64CheckSafeIntMinMax
                                             : (IntRegion<
                                                    T, U>::IntZone_Int64_Int ||
                                                IntRegion<
                                                    T, U>::IntZone_Int64_Int64)
                                                   ? SubtractionState_Int64Int
                                                   : (IntRegion<T, U>::
                                                          IntZone_IntLT64_Int64)
                                                         ? SubtractionState_IntInt64
...
class SafeInt {
 public:
  ...
  SafeInt<T, E> operator++(int)
      SAFEINT_CPP_THROW  // dummy arg to comply with spec
  {
    if (m_int != IntTraits<T>::maxInt) {
...
#define ShiftAssert(x) SAFEINT_ASSERT(x)
  ...
  SafeInt<T, E> Min(SafeInt<T, E> test, const T floor = IntTraits<T>::minInt)
      const SAFEINT_NOTHROW {
    T tmp = test < m_int ? (T)test : m_int;
    return tmp < floor ? floor : tmp;
  }

  SafeInt<T, E> Max(SafeInt<T, E> test, const T upper = IntTraits<T>::maxInt)
      const SAFEINT_NOTHROW {
    T tmp = test > m_int ? (T)test : m_int;
...
SafeInt<ptrdiff_t, SafeIntDefaultExceptionHandler> SafePtrDiff(
    const P* p1, const P* p2) SAFEINT_CPP_THROW {
